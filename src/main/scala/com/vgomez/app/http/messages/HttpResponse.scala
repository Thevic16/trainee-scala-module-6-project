...
object HttpResponse {
  ...
  case class ReviewResponse(id: String, username: String, restaurantId: String, stars: Int, text: String,
    date: String)
  ...
  case class UserResponse(username: String, password: String, role: String, latitude: Double,
